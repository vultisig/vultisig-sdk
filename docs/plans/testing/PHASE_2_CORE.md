...
describe('VaultManager', () => {
  ...
  describe('vault management', () => {
    ...
    it('should not delete active vault', async () => {
      ...
      await expect(
        vaultManager.deleteVault(vault1.id)
      ).rejects.toThrow('Cannot delete active vault');
    });
  });
...
*Phase 2 provides comprehensive unit testing for core components. This foundation enables confident integration testing in Phase 3.*