...
export const buildVultFile = async (vault: any, password?: string) => {
  ...
  const containerBinary = toBinary(VaultContainerSchema as any, { vault: innerBase64, isEncrypted } as any)
  const containerBase64 = base64FromUint8(containerBinary as unknown as Uint8Array)
