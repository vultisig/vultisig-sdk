...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, balancePath, tronPath, utxoPath, decodePath, txPath, pricePath, parseOk: true, defiOk: true, bridgeOk: true, balanceOk: true, tronOk: true, utxoOk: true, decodeOk: true, txOk: true, priceOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
