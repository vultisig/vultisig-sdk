...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, gasPath, balancePath, tronPath, utxoPath, decodePath, policyPath, pricePath, txPath, dexPath, evmPath, cosmosPath, signablePath, parseOk: true, defiOk: true, bridgeOk: true, gasOk: true, balanceOk: true, tronOk: true, utxoOk: true, decodeOk: true, policyOk: true, priceOk: true, txOk: true, dexOk: true, evmOk: true, cosmosOk: true, signableOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
