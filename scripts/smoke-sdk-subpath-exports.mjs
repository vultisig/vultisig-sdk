...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, decodePath, txPath, gasPath, policyPath, swapPath, prepPath, parseOk: true, defiOk: true, bridgeOk: true, decodeOk: true, txOk: true, gasOk: true, policyOk: true, swapOk: true, prepOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
