...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, gasPath, balancePath, tronPath, utxoPath, decodePath, prepPath, policyPath, pricePath, txPath, parseOk: true, defiOk: true, bridgeOk: true, gasOk: true, balanceOk: true, tronOk: true, utxoOk: true, decodeOk: true, prepOk: true, policyOk: true, priceOk: true, txOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
