...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, balancePath, tronPath, utxoPath, decodePath, txPath, parseOk: true, defiOk: true, bridgeOk: true, balanceOk: true, tronOk: true, utxoOk: true, decodeOk: true, txOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
    ...
    [
      ...
      "import { getXrpBalance, type XrpBalance } from '@vultisig/sdk/tools/balance'",
      ...
      'void chainConfig',
      'const balanceReader: typeof getXrpBalance = getXrpBalance',
      'void balanceReader',
      'const xrpBalance = null as unknown as XrpBalance',
      'void xrpBalance',
