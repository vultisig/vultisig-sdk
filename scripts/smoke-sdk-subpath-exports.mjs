...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, tronPath, utxoPath, decodePath, txPath, pricePath, parseOk: true, defiOk: true, bridgeOk: true, tronOk: true, utxoOk: true, decodeOk: true, txOk: true, priceOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
