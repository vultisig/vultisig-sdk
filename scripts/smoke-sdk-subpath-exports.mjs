...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, decodePath, txPath, tokenPath, parseOk: true, defiOk: true, bridgeOk: true, decodeOk: true, txOk: true, tokenOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
