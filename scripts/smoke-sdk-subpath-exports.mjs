...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, tronPath, utxoPath, decodePath, txPath, parseOk: true, defiOk: true, bridgeOk: true, tronOk: true, utxoOk: true, decodeOk: true, txOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
