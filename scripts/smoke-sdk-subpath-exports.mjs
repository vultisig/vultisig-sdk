...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, balancePath, tronPath, utxoPath, decodePath, prepPath, txPath, parseOk: true, defiOk: true, bridgeOk: true, balanceOk: true, tronOk: true, utxoOk: true, decodeOk: true, prepOk: true, txOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
