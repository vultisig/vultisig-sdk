...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'console.log(JSON.stringify({ parsePath, defiPath, bridgePath, gasPath, balancePath, tronPath, utxoPath, decodePath, policyPath, txPath, parseOk: true, defiOk: true, bridgeOk: true, gasOk: true, balanceOk: true, tronOk: true, utxoOk: true, decodeOk: true, policyOk: true, txOk: true }))',
      '',
    ].join('\n')
  )
  writeFileSync(
