...
test('browser example prepare recreates missing shared package artifacts', { timeout: 960_000 }, async () => {
...
test('browser example builds against the local SDK workspace package', { timeout: 720_000 }, async () => {
...
test('browser example dev server serves SDK wasm assets', { timeout: 720_000 }, async () => {
