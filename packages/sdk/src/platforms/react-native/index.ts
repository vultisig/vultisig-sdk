...
// Provider-aware swap arrival normalization. Keep the curated RN surface in
// parity with the root SDK entry so mobile consumers do not deep-import core or
// duplicate provider/status handling.
export type {
