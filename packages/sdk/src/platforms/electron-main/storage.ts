/**
 * Electron Main process storage implementation
 * Uses Node.js filesystem with Electron-specific userData path
 */
...
export class ElectronMainStorage implements Storage {
  public readonly basePath: string
  private initPromise?: Promise<void>

  constructor(config?: { basePath?: string }) {
    // Use Electron's userData directory by default
    this.basePath = config?.basePath ?? path.join(app.getPath('userData'), '.vultisig')
  }
