...
- [#2409](https://github.com/vultisig/vultisig-sdk/pull/2409) [`ba9674d`](https://github.com/vultisig/vultisig-sdk/commit/ba9674d09e67c9510210325ec75d59d802cce995) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Export the StakeKit action address and amount validators from the root and React Native entrypoints.

- [#2408](https://github.com/vultisig/vultisig-sdk/pull/2408) [`17e72f4`](https://github.com/vultisig/vultisig-sdk/commit/17e72f42d33543612556ae2736d3f85e9190bed0) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Expose the amount helper group through public imports and Vultisig instances, including amount.convert, while preserving existing flat conversion exports.

- [#2401](https://github.com/vultisig/vultisig-sdk/pull/2401) [`4969690`](https://github.com/vultisig/vultisig-sdk/commit/4969690ba037185a3ae873e295fd97cef71fec6a) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Expose `VaultBase.estimateSendFee()` with native fee-asset metadata for public fee previews.
...
- [#2399](https://github.com/vultisig/vultisig-sdk/pull/2399) [`43a81cd`](https://github.com/vultisig/vultisig-sdk/commit/43a81cd1d2435cf6cb0dc50b56965772b2f26f07) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Prefer the first supported non-approval transaction for StakeKit's single scan request, while preserving the complete ordered scan list and approval-only fallback.
...
- [#2308](https://github.com/vultisig/vultisig-sdk/pull/2308) [`1b3fb49`](https://github.com/vultisig/vultisig-sdk/commit/1b3fb498ad3f78b84b92b9f09b41fe8956fc5e9a) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Open SwapKit routing for HyperEVM sources and destinations and Robinhood destinations, while keeping Robinhood source swaps disabled until Blockaid supports chain 4663. Future EVM corridors can now use an unambiguous live SwapKit catalog identity without another static eligibility-list change, and catalog failures remain isolated from other quote providers.
...
- [#2303](https://github.com/vultisig/vultisig-sdk/pull/2303) [`bd15294`](https://github.com/vultisig/vultisig-sdk/commit/bd15294a739c7977b26704b7b6df38e83e6bda23) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Expose `BroadcastPartialFailureError` directly for failures after any transaction has been submitted.

- [#2319](https://github.com/vultisig/vultisig-sdk/pull/2319) [`7b65284`](https://github.com/vultisig/vultisig-sdk/commit/7b65284f7fe73f538283a201a416efdbbda0830c) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Reject checksum-invalid or wrong-network Dash, Zcash, Ripple, and Tron destinations when building or parsing THORChain limit-swap memos.
...
- [#2015](https://github.com/vultisig/vultisig-sdk/pull/2015) [`b2f63b7`](https://github.com/vultisig/vultisig-sdk/commit/b2f63b70c4dac0001f0f40521efa4412f1d9e1cb) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Export the Cardano transaction-validity policy: `getCardanoSendTtl`, `cardanoSlotOffset` and `cardanoBroadcastTtlSafetyMargin` are now reachable from the root and React Native entries. The TTL policy existed only inside the keysign resolver, so consumers building a Cardano transaction had no way to import it and hardcoded their own slot offset instead - which is how vultiagent-app ended up 10x off the value its own broadcast freshness guard judges transactions by. The keysign resolver now calls the same helper rather than re-deriving the offset.

- [#2007](https://github.com/vultisig/vultisig-sdk/pull/2007) [`536c320`](https://github.com/vultisig/vultisig-sdk/commit/536c32028bf1f66897bf018c19f36c298545841a) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Publish the canonical price helpers as a real `@vultisig/sdk/tools/price` subpath. The barrel existed in source but no export condition pointed at it, so `import '@vultisig/sdk/tools/price'` failed with `ERR_PACKAGE_PATH_NOT_EXPORTED` and consumers had to take the whole root surface or deep-import into `dist`. Adds the export conditions, the runtime bundle, the narrow declaration bundle, and packed-consumer smoke coverage.

- [#2253](https://github.com/vultisig/vultisig-sdk/pull/2253) [`c0c08f0`](https://github.com/vultisig/vultisig-sdk/commit/c0c08f0bd2337147d6b92ca7f391115edd7db62b) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Export the canonical IBC reverse route lookup across the SDK public surfaces so consumers can resolve source channels without rebuilding the route index.
...
- [#2019](https://github.com/vultisig/vultisig-sdk/pull/2019) [`78be14e`](https://github.com/vultisig/vultisig-sdk/commit/78be14ea9f1f011ded932ce6a9be5c19cf5694d0) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Publish `@vultisig/sdk/tools/policy` as a real package subpath with dedicated runtime and type bundles. The pure intent↔envelope policy diff layer (`policy.evaluate`, `policy.checkInvariants`, plus the underlying amount/chain-matching helpers) already existed and was re-exported from the root barrel, but consumers had no stable narrow surface to depend on and were pushed toward root-only imports or local wrappers.

- [#2029](https://github.com/vultisig/vultisig-sdk/pull/2029) [`76be65f`](https://github.com/vultisig/vultisig-sdk/commit/76be65fc297a43de6313b9dce3b096e6f764831a) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Route CCTP chain lookups through the SDK's canonical chain normalizer. `getCctpChain` was a raw object index, so `"base"` returned `undefined` while every other SDK helper accepts it, and callers had to pre-normalize for this one family. The CCTP builders now resolve the chain before the same-chain guard (so `('base', 'Base')` is still rejected rather than building a bridge from a chain to itself) and stamp the canonical chain name into the emitted envelope regardless of how the caller spelled it.

- [#1981](https://github.com/vultisig/vultisig-sdk/pull/1981) [`e23780f`](https://github.com/vultisig/vultisig-sdk/commit/e23780f0b292cd76e80c72c5ccdcdafebd73a735) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - `buildSplTransfer` now rejects known Solana burn/program destinations (System Program, SPL Token Program, Wrapped SOL mint, Incinerator) via the shared `assertSafeDestination` guard, closing a gap where its native-SOL sibling `prepareSendTxFromKeys` (guarded since [#1698](https://github.com/vultisig/vultisig-sdk/issues/1698)) rejected these but the SPL token path did not.

- [#1992](https://github.com/vultisig/vultisig-sdk/pull/1992) [`30499f8`](https://github.com/vultisig/vultisig-sdk/commit/30499f83f9909d8eb9bc1d310b25fdadb5c240e7) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Add `cronoschain` / `cronos chain` -> `cronos` to the StakeKit network alias map. `CronosChain` is the SDK's own canonical `Chain` id and was the one canonical id in StakeKit's supported set that did not round-trip: `balances({ network: 'CronosChain' })` sent the literal `cronoschain` upstream as an unknown slug and returned `[]`, which reads as "you hold nothing on Cronos" rather than "that network name was not understood".

- [#2003](https://github.com/vultisig/vultisig-sdk/pull/2003) [`534154b`](https://github.com/vultisig/vultisig-sdk/commit/534154b6e9daaffad5d2e4958af3ead5fa940f21) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Nest `validatorAddresses` inside `args` on the StakeKit `exit` REST fallback body, matching the `enter` path and the declared `{ integrationId, addresses, args }` wire shape. It was previously sent as a top-level sibling, outside the field the API contract declares — a validator-targeted unstake/withdraw over the REST fallback could silently lose its validator selection.
...
- [#2102](https://github.com/vultisig/vultisig-sdk/pull/2102) [`2869ae6`](https://github.com/vultisig/vultisig-sdk/commit/2869ae60bc157e2020a541e31a50afabef4e9edc) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Add the missing `./server` export map entry (JS/CJS/DTS) so `@vultisig/sdk/server` is actually importable — the module existed but had no package.json subpath wiring. Packaging-only, no signing/broadcast behavior change.
...
- [#2088](https://github.com/vultisig/vultisig-sdk/pull/2088) [`f86320b`](https://github.com/vultisig/vultisig-sdk/commit/f86320bcfbee02b2f27473ac41a042db307596f6) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Adds the AgentRouter / USDC checkout canonical primitive family under `@vultisig/sdk`'s EVM tools (`evm.*` / top-level): a USDC payment-chain registry (`USDC_PAYMENT_CHAIN_CONFIG`, `USDC_CONTRACTS`, `CHECKOUT_CHAIN_IDS`, `lookupUsdcPaymentChain`, `resolveUsdcPaymentContract`, `resolveUsdcPaymentChainId`), `formatCheckoutUsdcDisplay` (the half-away-from-zero microdollar → USD display formatter), and `encodeAgentRouterDepositWithMemo`/`decodeAgentRouterDepositWithMemo` (ABI-driven via viem, so decode now also recovers the memo, not just the token/amount head). Previously these lived as two independently-drifting hand-rolled copies in `vultiagent-app` and `agent-backend-ts` — a display-formatting mismatch between the two already produced a real bug (app issue [#2528](https://github.com/vultisig/vultisig-sdk/issues/2528)).

- Updated dependencies [[`c0eafeb`](https://github.com/vultisig/vultisig-sdk/commit/c0eafeb12df42cffa70ef6951c081a74383e5fa2), [`3d40017`](https://github.com/vultisig/vultisig-sdk/commit/3d400171facf1107472e827c4ef48d7dd99843f1), [`ef252e4`](https://github.com/vultisig/vultisig-sdk/commit/ef252e40b590a6cad9f303f7aba743c617442f90), [`4e23e92`](https://github.com/vultisig/vultisig-sdk/commit/4e23e9205310e46564bc1782b57499b2a39d7a5f), [`4561c65`](https://github.com/vultisig/vultisig-sdk/commit/4561c6584f62fa78d17546bcc119e31b6ea665cb), [`bfe0292`](https://github.com/vultisig/vultisig-sdk/commit/bfe0292e3876fb7acc7044bac1b544c27aba8919), [`acd0b2e`](https://github.com/vultisig/vultisig-sdk/commit/acd0b2eaa882669a399fb378e51244ed4199ee47)]:
  - @vultisig/mpc-types@0.3.0
  - @vultisig/core-chain@4.1.1
  - @vultisig/core-mpc@2.1.1
  - @vultisig/mpc-native@1.0.1
...
- [#2010](https://github.com/vultisig/vultisig-sdk/pull/2010) [`f170bdd`](https://github.com/vultisig/vultisig-sdk/commit/f170bdddafd80d892cd35a050cf8f5393776a6a0) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - `vault.swap({ amount: 'max' })` now resolves `max` through the fee-aware `maxSwapable` its own quote already computes, instead of committing the full source balance. A native max swap previously over-committed by exactly the network fee and failed at prepare/broadcast with insufficient funds, after the caller had been told the swap was viable. Routes that cannot price their source-chain fee at quote time (deposit-channel transfers) now fail closed with an actionable error rather than building against a balance that is not safe to spend. This matches what `send({ amount: 'max' })` has always done.
...
- [#2142](https://github.com/vultisig/vultisig-sdk/pull/2142) [`bd44426`](https://github.com/vultisig/vultisig-sdk/commit/bd44426fe80b160d8c9a0a866e3cbb759bf781ba) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Restore Cosmos governance parity with the agent backend by accepting Sei, Injective, Neutron, Celestia, and Stride (including their chain IDs) for proposal reads and unsigned vote preparation. Terra Classic `gov/v1beta1` proposal filters now use the required integer enum values instead of `PROPOSAL_STATUS_*` strings.
...
- [#2164](https://github.com/vultisig/vultisig-sdk/pull/2164) [`6c535ae`](https://github.com/vultisig/vultisig-sdk/commit/6c535ae3aed1c376d2e1bbbeb100e8b5c21c8929) Thanks [@Ehsan-saradar](https://github.com/Ehsan-saradar)! - Route the Kamino Earn API through the Vultisig proxy. Upstream answers the CORS preflight with a 404 and returns no `access-control-allow-origin` on the build endpoints, so a browser refuses the POST that deposits and withdrawals depend on — the flows hung on the review screen in any webview. Native clients never saw it, because CORS is enforced by the browser rather than the server.

- [#2177](https://github.com/vultisig/vultisig-sdk/pull/2177) [`5bf33f2`](https://github.com/vultisig/vultisig-sdk/commit/5bf33f264c90ec4055d2c12e90222bec9aea501b) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Expose the Hermes-safe seedphrase validation, language detection, key derivation, and import-policy helpers from the React Native entrypoint.
...
- [#2039](https://github.com/vultisig/vultisig-sdk/pull/2039) [`1672265`](https://github.com/vultisig/vultisig-sdk/commit/16722657dcefafff32744a7673c277e403e62a77) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Deduplicated the cosmos validator/account bech32 role guard (fund-safety: rejecting a `valoper`/`valcons` address where a spendable account is required). `ibcTransfer.ts` and `cosmosStaking.ts` each carried their own private reimplementation of the HRP-suffix classification alongside the canonical one in `tools/swap/skip/cosmosAddressGuard.ts`; both now import and consume the shared `validatorRoleForHrp` helper instead, so the fund-safety rule can no longer drift silently across call sites.
...
- [#1779](https://github.com/vultisig/vultisig-sdk/pull/1779) [`e5937ee`](https://github.com/vultisig/vultisig-sdk/commit/e5937ee938eb19adc423a7d5ca29cee71f0592f4) Thanks [@neavra](https://github.com/neavra)! - Store CLI-managed token IDs as bare lowercase EVM contract addresses, retain reads of legacy chain-prefixed IDs, and use stable ecosystem token names in discovery. Ambiguous token symbols now fail closed, discovery collisions use address-derived discriminators, and re-adding legacy-stored contracts remains idempotent. Token removal now emits the standard JSON success envelope and token-add help documents its required name.
...
- [#1947](https://github.com/vultisig/vultisig-sdk/pull/1947) [`144cc70`](https://github.com/vultisig/vultisig-sdk/commit/144cc7085d63eb6111ae5f8b0fc948af224ecc21) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Fix `getEvmBalances` failing on ERC-20 tokens whose `symbol()` returns a legacy bytes32 (e.g. MKR) instead of a dynamic string, aborting the whole balance batch.

- [#1664](https://github.com/vultisig/vultisig-sdk/pull/1664) [`42d46b6`](https://github.com/vultisig/vultisig-sdk/commit/42d46b640bb7577d2cc98af31a8776fa04728fd2) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Export `buildBalancerV3SwapCalldata` from the root SDK surface so Node and browser consumers can import it the same way React Native consumers already can.

- [#1658](https://github.com/vultisig/vultisig-sdk/pull/1658) [`fbdd174`](https://github.com/vultisig/vultisig-sdk/commit/fbdd174c24a79b81559e1775e33841fb024ef142) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Publish `@vultisig/sdk/chains/tron` and `@vultisig/sdk/chains/utxo` as real package subpaths with dedicated runtime and type bundles.

- [#1662](https://github.com/vultisig/vultisig-sdk/pull/1662) [`ef3d8f2`](https://github.com/vultisig/vultisig-sdk/commit/ef3d8f2e37d5c8686835b9f14d36c10e2eab3a08) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Export the custom-RPC override registry and health-probe helpers from the root and React Native SDK entrypoints.
...
- [#1872](https://github.com/vultisig/vultisig-sdk/pull/1872) [`94fe7b4`](https://github.com/vultisig/vultisig-sdk/commit/94fe7b482d5df9d382064c089c107acbd39524e4) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Publish `@vultisig/sdk/tools/balance` as a real package subpath with dedicated JS and declaration bundles.
...
- [#1722](https://github.com/vultisig/vultisig-sdk/pull/1722) [`f914e7c`](https://github.com/vultisig/vultisig-sdk/commit/f914e7c1c6f430fa54116f4c0a82f19919e0fbf6) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Preserve top-level routing metadata when normalizing flat tx payloads, and carry `chain` / `from_chain` / `to_chain` args onto split multi-leg transactions. This keeps `normalizeTx()` and `splitMultiTx()` consistent for downstream app/backend consumers that rely on the canonical SDK envelope contract.
...
- [#1495](https://github.com/vultisig/vultisig-sdk/pull/1495) [`3d0fd71`](https://github.com/vultisig/vultisig-sdk/commit/3d0fd71b923d57e52ae5760656051be22323947d) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Export the canonical `IbcEnabledCosmosChain` and `VaultBasedCosmosChain` subsets from the root and React Native SDK entrypoints so first-party consumers can stop mirroring staking-chain allowlists.

- [#1498](https://github.com/vultisig/vultisig-sdk/pull/1498) [`e869b4d`](https://github.com/vultisig/vultisig-sdk/commit/e869b4d0a1da17d6278ca37c991673a9b4dd0c8d) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Export `buildKeygenPairingQrPayload` from the root and React Native SDK entrypoints so first-party consumers can build canonical secure-vault pairing QR payloads without deep-importing internal service paths.

- [#1829](https://github.com/vultisig/vultisig-sdk/pull/1829) [`0a73b05`](https://github.com/vultisig/vultisig-sdk/commit/0a73b056a6d9fa1dc3c4c115e8c9850bcede0403) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Reject Polkadot asset-send amounts above pallet_assets `u128` and TRON TRC-20 fee limits above protobuf `int64` (at both the prep and raw-builder layers) instead of silently truncating or overflowing. Closes [#1827](https://github.com/vultisig/vultisig-sdk/issues/1827), [#1828](https://github.com/vultisig/vultisig-sdk/issues/1828).

- [#1962](https://github.com/vultisig/vultisig-sdk/pull/1962) [`01f92f5`](https://github.com/vultisig/vultisig-sdk/commit/01f92f5b20461e62625b743d27a6a7571f9b0d74) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Fail closed instead of silently rounding: `getSolBalance()`'s `lamports` field is now `number | null`, returning `null` once the exact u64 balance exceeds `Number.MAX_SAFE_INTEGER` instead of re-exposing a value already corrupted by `Number()` coercion. `lamportsRaw` (base-10 string) and `sol` (exact decimal string) remain lossless across the full range and are unaffected.

- [#1716](https://github.com/vultisig/vultisig-sdk/pull/1716) [`2a35932`](https://github.com/vultisig/vultisig-sdk/commit/2a35932cbde4eddad4edf9462e9f0b4063a56f62) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Preserve camelCase transaction metadata like `chainId`, `fromChain`, `toChain`, symbols, addresses, and decimals when `splitMultiTx()` expands a `transactions[]` build result into per-leg envelopes. This keeps newer SDK-native multi-leg builders from silently losing routing/display metadata that downstream app and backend consumers need.
...
- [#1753](https://github.com/vultisig/vultisig-sdk/pull/1753) [`0bd1a2d`](https://github.com/vultisig/vultisig-sdk/commit/0bd1a2dfcfc723c77a684be62cc4a676824dc217) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Prevent stale vault instances from overwriting newer storage updates. `vault.save()` now rejects stale writes with
...
- [#1754](https://github.com/vultisig/vultisig-sdk/pull/1754) [`a6ba6b4`](https://github.com/vultisig/vultisig-sdk/commit/a6ba6b4688027d6abf4ce0eb3385d6e141f5ef57) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Harden React Native Solana broadcasting with deterministic signatures, idempotent duplicate handling, and signature-status verification for ambiguous send errors.
...
- [#1601](https://github.com/vultisig/vultisig-sdk/pull/1601) [`c49a3f2`](https://github.com/vultisig/vultisig-sdk/commit/c49a3f2bdff6d220960c3609d08b6c848961ed9f) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix address-format validation to honor canonical chain aliases and cosmos chain ids via `normalizeChain`
...
- [#1689](https://github.com/vultisig/vultisig-sdk/pull/1689) [`82ea0b7`](https://github.com/vultisig/vultisig-sdk/commit/82ea0b7526ef7033605aeed461bb156416e4c012) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Wait for bundled ERC-20 approval transactions to confirm before broadcasting the dependent swap transaction.
...
- [#1191](https://github.com/vultisig/vultisig-sdk/pull/1191) [`8c1ad1e`](https://github.com/vultisig/vultisig-sdk/commit/8c1ad1ec73152ad161b2d17ffceeb166abafe30a) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Collapse balance and fiat-value N+1 request fan-out into batched calls.
...
- [#1455](https://github.com/vultisig/vultisig-sdk/pull/1455) [`ce7271f`](https://github.com/vultisig/vultisig-sdk/commit/ce7271fe009092d995b87a86c33cb830b37fc0a8) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Correlate secure-signing lifecycle events with stable per-operation session IDs.
...
- [#1214](https://github.com/vultisig/vultisig-sdk/pull/1214) [`802910d`](https://github.com/vultisig/vultisig-sdk/commit/802910d74219ba11e7e819d38bbafd88843028b8) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Fix the CCTP Base MessageTransmitter address to Circle's published contract (0xAD09780d193884d503182aD4588450C416D6F9D4). The previous value was a codeless EOA lookalike, so a Base claim's receiveMessage succeeded without minting (burn-without-mint fund loss). Registry is now pinned to Circle's published V1 addresses by test.
...
- [#1192](https://github.com/vultisig/vultisig-sdk/pull/1192) [`5303d70`](https://github.com/vultisig/vultisig-sdk/commit/5303d704e792bb7ed70df08eab7140aac81a519a) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Export the EVM chainId ↔ chain helpers (`getEvmChainId`, `getEvmChainByChainId`)
...
- [#1252](https://github.com/vultisig/vultisig-sdk/pull/1252) [`9b5d103`](https://github.com/vultisig/vultisig-sdk/commit/9b5d103500cce4f984dc7049a316529a193716f2) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Add real published subpath bundles for `@vultisig/sdk/tools/parse` and `@vultisig/sdk/tools/defi`, including dedicated declaration output and package-name import smoke coverage.
...
- [#1258](https://github.com/vultisig/vultisig-sdk/pull/1258) [`a8c10f0`](https://github.com/vultisig/vultisig-sdk/commit/a8c10f02423760c805593b0a1ad9c25a83609e1f) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Centralize native-swap chain-id lookups behind a canonical `getNativeSwapChainId` accessor, removing duplicated nullable-map wrappers from the SDK broadcast guard and native-swap core helpers.
...
- [#1426](https://github.com/vultisig/vultisig-sdk/pull/1426) [`b3d17d8`](https://github.com/vultisig/vultisig-sdk/commit/b3d17d855c2e2250c78641912d70203a43fdf332) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Fix `vault.broadcastRawTx` reporting a false success for a Cosmos transaction that was included but failed execution. `RawBroadcastService.broadcastCosmosRawTx` returned `result.transactionHash` whenever `StargateClient.broadcastTx` didn't throw, but that client resolves (does not throw) once a tx is included even when DeliverTx failed (`code !== 0` — out-of-gas, wasm revert, a THORChain/Maya deposit-handler rejection). The tx is on-chain but nothing moved, so the raw path now asserts DeliverTx success and throws `BroadcastFailed` on execution failure, matching the signing-input broadcast resolver ([#1316](https://github.com/vultisig/vultisig-sdk/issues/1316)).

- [#1380](https://github.com/vultisig/vultisig-sdk/pull/1380) [`afa17b2`](https://github.com/vultisig/vultisig-sdk/commit/afa17b2aee9abea47a52cfdee433d2cf2ae58ced) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(rn): key the React Native `getCoinBalance` resolver dispatch by `ChainKind`
...
- [#1379](https://github.com/vultisig/vultisig-sdk/pull/1379) [`9510a9d`](https://github.com/vultisig/vultisig-sdk/commit/9510a9d8099c52a482dff05a3cf49938e06d9a85) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - Re-check THORChain/MayaChain trading-halt flags at broadcast on BOTH ends of the native swap route, not only the source chain. A chain healthy at quote time can `HALT<CHAIN>TRADING` before broadcast while the inbound vault address stays current; a destination halt would otherwise let the deposit land while the outbound cannot leave (stuck funds). Mirrors quote-time `getNativeSwapTradingHalt`'s source+destination selection and its tolerance (a route leg with no inbound entry is skipped, not false-blocked), and reads `global_trading_paused` across all inbound entries. Fail-closed at zero extra network cost (the flags ride the already-fetched inbound object).
...
- [#999](https://github.com/vultisig/vultisig-sdk/pull/999) [`99db752`](https://github.com/vultisig/vultisig-sdk/commit/99db752f093575f90b99b30674ec9be8af49fed9) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - feat(cosmos): parameterize the THORChain-family MsgDeposit asset (THOR.RUNE / MAYA.CACAO)
...
- [#960](https://github.com/vultisig/vultisig-sdk/pull/960) [`2585dc1`](https://github.com/vultisig/vultisig-sdk/commit/2585dc1830dd7b28694edd411991b24c3fad1538) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(evm): chunk the 1inch token-metadata request so token-rich wallets don't 414. `findEvmCoins` joined every held-token address into one `/custom` GET, overflowing the proxy URI (HTTP 414) and killing discovery of all tokens; requests are now batched (50/req) and non-fatal per batch.

- [#967](https://github.com/vultisig/vultisig-sdk/pull/967) [`152bb4a`](https://github.com/vultisig/vultisig-sdk/commit/152bb4a2b717efa2f1edb14b7e19cdeba87450c7) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(cardano): paginate `address_assets` so NFT-heavy wallets aren't truncated. A single unbounded Koios query capped at 1000 rows, dropping tokens past 1000 in both discovery and per-token balance; it now follows the offset/limit pages.

- [#968](https://github.com/vultisig/vultisig-sdk/pull/968) [`4a58c6c`](https://github.com/vultisig/vultisig-sdk/commit/4a58c6c1294c88e5d937c3dde24e50edd3fdf2a0) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(cosmos): paginate token discovery so IBC-heavy wallets aren't truncated. cosmjs `getAllBalances` issues a single unpaginated query capped at the node default (100), dropping denoms past 100; discovery now walks the LCD balances pages with a fall-through to cosmjs.

- [#969](https://github.com/vultisig/vultisig-sdk/pull/969) [`ed46385`](https://github.com/vultisig/vultisig-sdk/commit/ed46385358883ed5277f8771ba73000afec9859e) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(evm): one token's on-chain metadata failure no longer kills all discovery. `getDiscoveredEvmCoin` re-threw inside `findEvmCoins`' `Promise.all`, so a single transient metadata read rejected discovery of every token on the chain; it now skips just the failing token.

- [#966](https://github.com/vultisig/vultisig-sdk/pull/966) [`72082a6`](https://github.com/vultisig/vultisig-sdk/commit/72082a65eab226cebf562863bcb99346b81ca831) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(polkadot): reject an invalid destination instead of self-sending. `resolvePolkadotToAddress` (Polkadot + Bittensor) fell back to the sender's own address on a missing/invalid `toAddress`, so the signed extrinsic could diverge from the approved pre-sign card; it now throws.

- [#962](https://github.com/vultisig/vultisig-sdk/pull/962) [`a9266a1`](https://github.com/vultisig/vultisig-sdk/commit/a9266a1753ca474b3f337f8a605900acdd7508b0) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(solana): use Promise.allSettled across the SPL token programs so one program's failure doesn't hide the other's holdings. `getSplAccounts` used Promise.all, so a single token-program RPC failure (e.g. a 520) rejected the whole lookup; it now only throws when both programs fail.

- [#965](https://github.com/vultisig/vultisig-sdk/pull/965) [`2791af8`](https://github.com/vultisig/vultisig-sdk/commit/2791af8a1e539103678ba71b774d62d2e7691a29) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(sui): paginate `getAllCoins` so sends see every coin object. The keysign resolver read only the first ~50-object page, truncating the coin set used for gas + input selection and producing a broken send on wallets with >50 coin objects.

- [#964](https://github.com/vultisig/vultisig-sdk/pull/964) [`b68ddad`](https://github.com/vultisig/vultisig-sdk/commit/b68ddadbc6295957cbb4b37c365a4062b0a2576f) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(ton): fail closed on a null account-info result before it crashes keysign. A transient `ok:false`/null-result response from `getExtendedAddressInformation` slipped through as a 200 and crashed the TON keysign resolver on `const { account_state } = undefined`; `getTonAccountInfo` now throws a descriptive error instead of returning null.

- [#970](https://github.com/vultisig/vultisig-sdk/pull/970) [`ab5e413`](https://github.com/vultisig/vultisig-sdk/commit/ab5e413ead62da47dc144e591ac310d1d4328a56) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(tron): verify the base58check checksum on the TRC-20 balance-read address decode. `tronAddressToAbiParam` used plain `bs58.decode` with no checksum check, so a typo'd-but-decodable address silently queried a different account; it now uses `bs58check.decode`.

- [#959](https://github.com/vultisig/vultisig-sdk/pull/959) [`90f6ae5`](https://github.com/vultisig/vultisig-sdk/commit/90f6ae5a1865321e08bf6f03c17e23ed11006649) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(ripple): add the XRP reserve to the send amount check, not the burned fee. The base reserve was added to `gas` (the burned Fee) instead of being enforced against the Amount, burning ~1 XRP per fresh-address send; the resolver now sets the network fee correctly and rejects a send below the reserve.

- [#961](https://github.com/vultisig/vultisig-sdk/pull/961) [`7cfa332`](https://github.com/vultisig/vultisig-sdk/commit/7cfa332787f7646e049813a9f3b15613454f19d1) Thanks [@gomesalexandre](https://github.com/gomesalexandre)! - fix(evm): add zkSync to the 1inch-supported chains so its ERC-20s are discovered. zkSync was silently absent from `oneInchSupportedChains`, so token discovery returned an empty set even though the proxy serves chain 324.

- [#973](https://github.com/vultisig/vultisig-sdk/pull/973) [`c60d7c6`](https://github.com/vultisig/vultisig-sdk/commit/c60d7c6ecdf46e46bf1098cc57342d5fb79d2194) Thanks [@rcoderdev](https://github.com/rcoderdev)! - Reject non-decimal send amounts such as hex and scientific notation with `InvalidAmount`.
