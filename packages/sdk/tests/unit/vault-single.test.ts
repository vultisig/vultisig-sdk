...
describe('Single Vault Tests', () => {
  ...
  describe('Vault Import and Basic Operations', () => {
    test('should import encrypted vault and verify properties', async () => {
      ...
      expect(vault.data.publicKeys.ecdsa).toBe(
        '03ac0f333fc5d22f929e013be80988f57a56837db64d968c126ca4c943984744fd'
      )
      expect(vault.data.publicKeys.eddsa).toBe(
        'dff9b5b456eadcbd99366fd691f50f865a26df433f9cbffe1b6f319ecadb8308'
      )
  ...
  describe('Error Handling', () => {
    ...
    test('should handle wrong password for encrypted vault', async () => {
      ...
      await expect(
        vultisig.addVault(vaultFile, 'WrongPassword')
      ).rejects.toThrow()
    })
