...
export class RujiraError extends Error {
  ...
  constructor(code: RujiraErrorCode, message: string, details?: unknown, retryable = false) {
    super(message)
 ...
 */
const RETRYABLE_ERRORS = new Set([RujiraErrorCode.NETWORK_ERROR, RujiraErrorCode.RPC_ERROR, RujiraErrorCode.TIMEOUT])
