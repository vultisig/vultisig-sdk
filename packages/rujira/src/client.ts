import { CosmWasmClient, ExecuteResult, SigningCosmWasmClient } from '@cosmjs/cosmwasm'
...
export class RujiraClient {
  ...
  private async queryContractViaRest<T>(contractAddress: string, query: object): Promise<T> {
