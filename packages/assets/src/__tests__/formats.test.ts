...
describe('Format Converters', () => {
  ...
  describe('THORChain parsing', () => {
    ...
    it('should extract contract from THORChain format', () => {
      ...
      expect(extractContractFromThorchain('ETH.USDC-0XA0B86991C6218B36C1D19D4A2E9EB0CE3606EB48'))
        .toBe('0XA0B86991C6218B36C1D19D4A2E9EB0CE3606EB48');
      expect(extractContractFromThorchain('BASE.CBBTC-0XCBB7C0000AB88B473B1F5AFD9EF808440EED33BF'))
        .toBe('0XCBB7C0000AB88B473B1F5AFD9EF808440EED33BF');
    });
  });
  ...
  describe('format building', () => {
    it('should build THORChain format', () => {
      ...
      expect(buildThorchainFormat('eth', 'usdc', '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48'))
    ...
    it('should build FIN format (corrected)', () => {
      ...
      expect(buildFinFormat('eth', 'usdc', '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48'))
        .toBe('eth-usdc-0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48');
