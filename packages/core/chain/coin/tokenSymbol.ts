/**
 * Homoglyphs scammers substitute into a token symbol so it *reads* like a
...
/**
 * Collapses a token symbol or name to the Latin skeleton a user perceives, so
 ...
 * Chain-agnostic: every chain's counterfeit heuristic compares these skeletons.
 */
export const normalizeTokenSymbol = (value: string): string =>
