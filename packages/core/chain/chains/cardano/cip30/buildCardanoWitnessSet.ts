 ...
 */
import { cborArray, cborBytes, cborMap, cborUint } from './cardanoCborPrimitives'
...
export const buildCardanoWitnessSet = ({ publicKey, signature }: BuildCardanoWitnessSetInput): Uint8Array =>
  cborMap([[cborUint(0), cborArray([cborArray([cborBytes(publicKey), cborBytes(signature)])])]])
