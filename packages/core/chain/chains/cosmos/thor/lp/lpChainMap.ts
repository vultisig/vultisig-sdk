...
export const lpChainMap: Readonly<Record<string, Chain>> = Object.freeze(
  Object.entries(thorchainLpChainCode).reduce<Record<string, Chain>>((acc, [chainKey, prefix]) => {
    if (prefix) {
 ...
 */
export const chainPrefixToChain = (prefix: string): Chain | undefined => lpChainMap[prefix.toUpperCase()]
 ...
 */
export const chainToLpPrefix = (chain: Chain): string | undefined => thorchainLpChainCode[chain]
