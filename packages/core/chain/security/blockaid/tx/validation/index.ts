...
import { BlockaidTxValidationInput, BlockaidTxValidationResolver } from './resolver'
...
const resolvers: Record<DeriveChainKind<BlockaidValidationSupportedChain>, BlockaidTxValidationResolver<any>> = {
...
export const getTxBlockaidValidation = async (input: BlockaidTxValidationInput): Promise<BlockaidValidation> => {
