...
export const scanSiteWithBlockaid = async (url: string): Promise<BlockaidSiteScanResult> => {
  const { is_malicious } = await queryBlockaid<BlockaidSiteScanResponse>('/site/scan', {
