...
export const swap = {
  description: 'Swap tokens between chains. Previews by default — set confirmed to execute.',
  params: {
    from: 'Source chain or chain:token (e.g. Ethereum or Ethereum:USDC)',
    to: 'Destination chain or chain:token',
    amount: 'Amount to swap in human-readable units (e.g. "0.1")',
...
export const send = {
  description: 'Send tokens to an address. Previews by default — set confirmed to execute.',
  params: {
