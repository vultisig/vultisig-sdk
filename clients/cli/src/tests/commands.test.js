...
describe('CLI Commands Tests', () => {
  ...
  describe('Help Command', () => {
    ...
    test('should show command-specific help', () => {
      const output = execSync(`${CLI_PATH} address --help`, { encoding: 'utf8' });
  ...
  describe('Status Command', () => {
    test('should show daemon status when no daemon running', () => {
      try {
        const output = execSync(`${CLI_PATH} status`, { encoding: 'utf8', stdio: 'pipe' });
  ...
  describe('Error Handling', () => {
    test('should handle invalid commands gracefully', () => {
      try {
        execSync(`${CLI_PATH} invalid-command`, { encoding: 'utf8', stdio: 'pipe' });
