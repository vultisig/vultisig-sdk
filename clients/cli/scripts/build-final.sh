 ...
 * 
 * ⚠️  WARNING: THIS FILE IS AUTO-GENERATED BY scripts/build-final.sh
 * ⚠️  DO NOT EDIT THIS FILE MANUALLY - Changes will be lost on rebuild!
 * ⚠️  To modify this file, edit the heredoc in scripts/build-final.sh
 * 
 * This launcher:
