...
export const finalsession_new: (a: any, b: number, c: number, d: number) => [number, number, number];
export const finalsession_setup: (a: number, b: number, c: any, d: number, e: number) => [number, number, number];
...
export const keyshare_publicKey: (a: number) => any;
...
export const keyshare_rootChainCode: (a: number) => any;
