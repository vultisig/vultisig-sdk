...
class FinalSession {
    ...
    constructor(setup, id, pre) {
        ...
        const ret = wasm.finalsession_new(setup, ptr0, len0, ptr1);
        if (ret[2]) {
...
module.exports.FinalSession = FinalSession;
...
const path = require('path').join(__dirname, 'vs_wasm_bg.wasm');
