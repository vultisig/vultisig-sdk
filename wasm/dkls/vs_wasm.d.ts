...
export interface InitOutput {
  ...
  readonly finalsession_new: (a: any, b: number, c: number, d: number) => [number, number, number];
  readonly finalsession_setup: (a: number, b: number, c: any, d: number, e: number) => [number, number, number];
  ...
  readonly keyshare_publicKey: (a: number) => any;
  ...
  readonly keyshare_rootChainCode: (a: number) => any;
